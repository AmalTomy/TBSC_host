...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'amaltomy321@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'mqhi mmoe ucqk dzjj')
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'amaltomy321@gmail.com')

SITE_ID = 1 

TWILIO_ACCOUNT_SID = os.environ.get('TWILIO_ACCOUNT_SID', 'ACa7a2f6611c41f82d39f3cdcc9fc0a2fb')
TWILIO_AUTH_TOKEN = os.environ.get('TWILIO_AUTH_TOKEN', '1d5c259c581172b354336a893ea3e8eb')
TWILIO_PHONE_NUMBER = os.environ.get('TWILIO_PHONE_NUMBER', '+12089032893')

# Add this to your existing settings
OPENWEATHERMAP_API_KEY = os.environ.get('OPENWEATHERMAP_API_KEY', '45b01a7f6a9893cc9370a6fd91f105fb')
